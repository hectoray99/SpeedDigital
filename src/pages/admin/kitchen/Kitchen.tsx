...
import { Loader2, ChefHat, CheckCircle, Clock, RefreshCw, Printer, Eye, Hand, ListTodo, Flame, CheckCircle2 } from 'lucide-react';
        ...
        <div className={`bg-white rounded-2xl shadow-sm border p-5 flex flex-col animate-in slide-in-from-bottom-2 duration-300 ${
            ...
            <div className="flex justify-between items-start mb-4 border-b border-slate-100 pb-3">
                <div>
                    ...
                    <p className="text-xs text-slate-500 font-bold flex items-center gap-1.5 mt-1 bg-slate-50 w-fit px-2 py-1 rounded-md">
